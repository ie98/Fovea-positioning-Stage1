...
from src.network_2.SPP.sppmodule import PSPModule
from src.network_2.v1.fm1.FeatureMatch_1_1 import FeatureMatch
...
class mainNet(nn.Module):
    ...
    def forward(self,x_all,x_crop,t1,t2):

        x = self.resnet18_0_5(x_all) # 128 64 64
        ###### 辅助路线
        fm1,fm2 = self.featureMatch(x_crop,t1,t2) # 128 113 113  /  128 121 121  # 考虑对fm进行损失计算
        ...
        return mainPred,fm1Pred,fm2Pred
