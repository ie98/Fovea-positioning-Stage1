import numpy as np
import torch
import dataprocess.crossVal_old as DL
...
import logging
# from getDetail.computeRrate import computerRrate
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'

saveFileName = 'old trainer use odlTemplate no corssVal no aug no vat '
class trainer():
    ...
    def getTemplate_old(self,templatePath):
    ...
    def train(self,device):
        ...
        # Dict = torch.load('/home/stu013/mapping/HBDW_v3/modelParam/MESSIDOR/train in network using crossVal not dataAug bs 4/modelParam_173_3.4735212930491275.pth')
        ...
        batchSize = 4
        train_dataLoader, val_dateLoader , val_image_names = DL.getDataLoader(batchSize)
        ...
        # computer = computerRrate()

        # 获取模板图片
        templatePath1 = './template.jpg'
        ...
        for epoch in range(num_epoch):
            ...
            with torch.no_grad():
                ...
                # count = computer.computer(pred_site,saveFileName,epoch,val_image_names.reshape(-1))
