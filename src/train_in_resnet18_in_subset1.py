...
class trainer():
    ...
    def train(self):
        detail = 'train in subset1 & not freeze weight & batchsiz 16 & lr 0.001 & lrdec 0.001 & lrepoch 100 & numepochs 500'
        # 使用tensorBoard
        ...
        Dict = torch.load(
            '/home/stu013/mapping/HBDW_v3/modelParam/MESSIDOR/train in subset1 & freeze weight & batchsiz 16 & lr 0.001 & lrdec 0.001 & lrepoch 100 & numepochs 1000/modelParam_140_28.701291067558422_477.9915370941162.pth',
