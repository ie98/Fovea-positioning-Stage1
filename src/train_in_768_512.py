import numpy as np
import torch
import dataprocess.crossVal_768_512 as DL
...
saveFileName = 'imgSize 768*512 train in network using crossVal not dataAug bs 4 mult split strid 1 label not int'
class trainer():
    ...
    def train(self,device):
        ...
        optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate)
        # Scheduler 学习率下降曲线
        lf = lambda x: ((1 + math.cos(x * math.pi / 10)) / 2) * (1 - lrf) + lrf  # cosine
        ...
        # 获取模板图片
        templatePath1 = './template_sub1_strid_20.jpg'
        ...
        for epoch in range(num_epoch):
            ...
            with torch.no_grad():
                ...
                for i, data in tqdm(enumerate(val_LD)):
                    ...
                    R_8_list = dist_list[dist_list < 4.5]
