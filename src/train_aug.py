import numpy as np
import torch
import dataprocess.crossVal_aug as DL
...
saveFileName = 'train in network using crossVal with dataAug and batch size is 8'
class trainer():
    ...
    def __init__(self,arg_file=None):
        ...
        if os.path.exists('./outputFile/MESSIDOR/{}/my.log'.format(saveFileName)) is False:
            ...
            file.close()
        logging.basicConfig(filename='./outputFile/MESSIDOR/{}/my.log'.format(saveFileName), level=logging.DEBUG,
