    ...
    def train(self):
        ...
        for epoch in range(num_epoch):
            ...
            with torch.no_grad():
                ...
                dataframe.to_csv('./outputFile/MESSIDOR/resnet/val_detail_{}.csv'.format(epoch), sep=',')
                # 将结果 print 出來
                ...
                if epoch >= 150 :
                    if dist < best_dist:
                        ...
                        torch.save(best_model,'./modelParam/MESSIDOR/resnet/modelParam_{}_{}_{}.pth'.format(epoch,dist,plt_val_loss[-1]))
