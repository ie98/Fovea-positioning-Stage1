...
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('./End_use_model_Param/train_in_subset2.pth',map_location={'cuda:1':'cuda:0'})
        ...
        with torch.no_grad():
            ...
            if os.path.exists('testInMessidor/test_in_subset1') is False:
                os.makedirs('testInMessidor/test_in_subset1')
            ...
            dataframe.to_csv('./testInMessidor/test_in_subset1/{}/{}.csv'.format(saveFileName,'pre_subset1'), sep=',')
