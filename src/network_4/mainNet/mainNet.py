...
from src.network_4.SPP.sppmodule import PSPModule
from src.network_4.v1.fm1.FeatureMatch_1_1 import FeatureMatch
import cv2
...
class mainNet(nn.Module):
    def __init__(self):
        ...
        self.mainFc = nn.Linear(128*3*3,2)
    ...
    def forward(self,x_all,x_crop,epoch=None,iter=None,do=None):
        ...
        x = self.simple(x)
        mainPred = self.mainFc(x.view(x.size(0),-1))
        # # 多尺度融合
