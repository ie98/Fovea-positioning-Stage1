...
def getDataLoader(batchSize):
    ...
    # train_allImgNames = imgNames[sub_set_2]
    # dataFrame_testName = pd.DataFrame({'testName':test_imgNames,'trainName':train_allImgNames})
    # dataFrame_testName.to_csv('./trainInSubset2_testInSubset1.csv')
...
if __name__ == '__main__':
    train_loader,_ = getDataLoader(16)
